...
def iterate_batches(envs, batch_size=BATCH_SIZE):
    ...
    while True:
        ...
        if len(batch) == batch_size:
            ...
            # Holds data and waits for next() call against iterate_batches
...
if __name__ == "__main__":
    ...
    for batch_v in iterate_batches(envs):
        # create fake samples, input is 4D: batch, filters, x, y
        ...
        # Detach prevents gradient from calculating
        ...
        if iter_no % SAVE_IMAGE_EVERY_ITER == 0:
            ...
            # save_image(gen_output_v.data[:64], os.path.join('runs', f'fake_{iter_no}.png'), normalize=True)
