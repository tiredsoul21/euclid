...
```
# Training:
python3 rl_stock_model.train  -p /home/derrick/data/daily_price_data -r test --cuda

# Short training runs:
python3 rl_stock_model.train -p /home/derrick/data/daily_price_data/other -r test --cuda

# Batch testing
# python3 rl_stock_model.test  -d /home/derrick/data/daily_price_data/test/ -m valReward-22.174.data -n test-01

# Short testing run
# python3 rl_stock_model.test  -d /home/derrick/data/daily_price_data/test/FOX.csv -m valReward-22.174.data -n test-01

# Create plots
# python3 rl_stock_model.test  -d results-test-01.json -o "plot" -n test1
```
